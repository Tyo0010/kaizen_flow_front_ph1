function NumberCode() {
  return (
    <select
                                        id="country-code" name="countryCode" required
                                        className="block w-1/5 px-3 py-2 border border-gray-400 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-white"
                                        defaultValue="MY +60"
                                    >
                                        ...
                                        <option value="TF +262">TF +262</option>
                                        ...
                                        <option value="HM +672">HM +672</option>
                                        ...
                                        <option value="SX +1721">SX +1721</option>
